        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
          ...
          <tr>
            <td style="background:#12121f;padding:32px;border-left:1px solid rgba(255,107,0,0.2);border-right:1px solid rgba(255,107,0,0.2);">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background:rgba(37,211,102,0.1);border:1px solid rgba(37,211,102,0.3);border-radius:10px;"><tr><td style="padding:16px 20px;text-align:center;"><a href="https://wa.me/2290161973836" style="display:inline-block;background:#25D366;color:#ffffff;font-weight:700;font-size:14px;text-decoration:none;padding:12px 24px;border-radius:8px;">💬 Support WhatsApp →</a></td></tr></table>
            </td>
          </tr>
          <tr>
